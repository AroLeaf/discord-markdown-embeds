  ...
  parse() {
    while(this.tokens[this.pos]) {
      ...
      switch(token.type) {
        ...
        // title
        case types.title: {
          this.wraps(t => t.type === types.whitespace && t.value > 0, children => {
        ...
        // bold
        case types.bold: {
          this.wraps(t => t.type === types.bold, children => {
            this.push(new Parser(children, {
              type: nodes.bold,
            }).parse());
            this.pos += children.length + 2;
        ...
        case types.underline: {
          this.wraps(t => t.type === types.underline, children => {
            this.push(new Parser(children, {
        ...
        // italics
        case types.italics: {
          this.wraps(t => t.type === types.italics && t.value === token.value, children => {
            this.push(new Parser(children, {
              type: nodes.italics,
            }).parse());
            this.pos += children.length + 2;
        ...
        case types.strikethrough: {
          this.wraps(t => t.type === types.strikethrough, children => {
            this.push(new Parser(children, {
    ...
    if (this.nodes.at(0) instanceof nodes.whitespace) this.nodes.splice(0, 1);
    if (this.nodes.at(-1) instanceof nodes.whitespace) this.nodes.splice(this.nodes.length - 1, 1);
